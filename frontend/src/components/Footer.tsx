...
const Footer = () => {
  return (
    <footer className="app-footer relative flex items-center justify-center self-end bg-secondary/20 px-14 pb-24 pt-8 max-md:flex-col max-md:gap-8 max-sm:px-10">
